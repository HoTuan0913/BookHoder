    ...
    public class Utilities
    {
        ...
        public static async Task<string> UploadFile(Microsoft.AspNetCore.Http.IFormFile file, string sDirectory, string newname = null)
        {
            try
            {
                ...
                string path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "imageProduct", sDirectory);
                CreateIfMissing(path);
                string pathFile = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "imageProduct", sDirectory, newname);
